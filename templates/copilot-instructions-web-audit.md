...
This repository uses the GitHub Copilot web accessibility audit team. Apply WCAG 2.2 AA guidance to web UI code and prefer semantic HTML before ARIA.

Use `@web-accessibility-wizard` for a guided, multi-phase audit. It coordinates specialists for semantics, keyboard and focus behavior, forms, visual design, dynamic content, tables, links, cognitive accessibility, testing, and cross-page scoring.
